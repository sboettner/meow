...
public:
    ...
    void do_move_chunk(double t, float y, bool move_pitch_contour, bool move_time);
    void finish_move_chunk(double t, float y);

    void begin_move_edge(Track::Chunk*, double t);
    void do_move_edge(double t);
    void finish_move_edge(double t);
    ...
    void do_move_pitch_contour_control_point(double t, float y);
    void finish_move_pitch_contour_control_point(double t, float y);
...
private:
    ...
    Track::PitchContourIterator     curpci=nullptr;
